...
const defaultData = {
  ...
  electricity: [850, 920, 1050, 1180, 980, 880, 800],
  water: [45, 52, 65, 72, 68, 58, 50]
};
  ...
  series: [
    {
      ...
      areaStyle: {
        color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
          { offset: 0, color: '#ee666633' },
          { offset: 1, color: '#ee666610' }
        ])
      }
    },
    {
      ...
      areaStyle: {
        color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
          { offset: 0, color: '#73c0de33' },
          { offset: 1, color: '#73c0de10' }
        ])
      }
    }
  ]
...
const fetchData = async () => {
  try {
    const response = await axios.get('/api/energy-trend/c-building');
